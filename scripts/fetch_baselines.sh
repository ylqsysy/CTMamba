...
# If a global Git proxy is already configured, this script leaves it unchanged.
# We still pin conservative transport settings for more stable long-running clones.
git_clone_retry () {
  local url="$1"
  local out="$2"
  local tries=3
